...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/17 10:39:13 by fgabler           #+#    #+#             */
/*   Updated: 2025/12/17 10:39:14 by fgabler          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char *get_path_to_executable(const t_data *data, int current_path_pos);
...
void resolve_path(t_data *data)
{
	...
	{
		path_to_executable = get_path_to_executable(data, i);
...
static char *get_path_to_executable(const t_data *data, int current_path_pos)
{
	...
	path_to_executable = ft_strjoin(data->path[current_path_pos], "/"); // check for not freed mem
